            ...
            <div class="row">
                <div class="col-lg-10 col-md-12 col-xl-8">
                    <div class="block">
                        ...
                        <h1 class="mb-3 mt-3">Sistem Informasi Lapor Penerangan Jalan</h1>
                        <p class="mb-5">Website ini digunakan untuk memantau dan kerusakan lampu jalan pada kota merauke
                            dengan melihat laporan yang di kirim oleh masyarakat melalui website ini</p>

                        <a href="" target="_blank" class="btn btn-main">Lapor kerusakan sekarang<i
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <div class="process-block pl-4">
                        ...
                        <p class="mb-4">We understand what your business means to you,your requirements considering
            ...
            <div class="row">
                <div class="col-lg-12 testimonial-wrap">
                    <div class="testimonial-block">
                        <p>
                            Maiores quasi placeat harum itaque, ducimus cumque quas expedita hic. Qui ullam iste
                            provident mollitia expedita facilis fuga repellat.
                        </p>

                        <div class="client-info d-flex align-items-center">
                            <div class="client-img">
                                <img src="{{ asset('frontend_theme') }}/images/team/testimonial1.jpg" alt=""
                                    class="img-fluid">
                            </div>
                            <div class="info">
                                <h6>John Partho</h6>
                    ...
                    <div class="testimonial-block">
                        ...
                        <div class="client-info d-flex align-items-center">
                            <div class="client-img">
                                <img src="{{ asset('frontend_theme') }}/images/team/testimonial2.jpg" alt=""
                                    class="img-fluid">
                            </div>
                            <div class="info">
                                <h6>John Partho</h6>
